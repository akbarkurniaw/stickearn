...
WebUI.setText(findTestObject('02 CONTACT/03 Input Email'), 'ikhszydotcom')
...
WebUI.click(findTestObject('02 CONTACT/06 Button SendMessage'), FailureHandling.STOP_ON_FAILURE)

verif2 = WebUI.verifyAlertPresent(0)

if (verif2 == true) {
    String alertText = WebUI.getAlertText()
	def checker = ['invalid', 'email','format', 'cannot']
