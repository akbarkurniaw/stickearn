...
WebUI.click(findTestObject('05 LOGIN/06 Button Close'))

WebUI.delay(2)

def verif = WebUI.verifyElementNotVisible(findTestObject('05 LOGIN/02 Label Pop Up'), FailureHandling.STOP_ON_FAILURE)

if (verif == true) {
	KeywordUtil.markPassed('Berhasil membatalkan login')
	WebUI.closeBrowser()
} else {
	KeywordUtil.markFailed('Gagal membatalkan login')
	WebUI.closeBrowser()
}
