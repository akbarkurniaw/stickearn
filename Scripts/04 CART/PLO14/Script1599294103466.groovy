...
verif1 = WebUI.verifyElementPresent(findTestObject('04 CART/16 Cart 1st Data'), 0)
...
WebUI.click(findTestObject('04 CART/15 Button Delete'))

WebUI.delay(2)

verif2 = WebUI.verifyElementNotPresent(findTestObject('04 CART/16 Cart 1st Data'), 0)
